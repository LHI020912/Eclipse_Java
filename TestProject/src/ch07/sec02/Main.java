...
//다른 패키지 클래스 import 시 해당클래스는 public (생략되면 import 불가능)
import ch07.sec01.Add;		//다른 패키지 Class import Add public
//import ch07.sec01.Divide;	//접근제한 생략된 클래스이므로 import 불가
